...
@Rudra1.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@Rudra2.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@Rudra3.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@Rudra4.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@Rudra5.on(events.NewMessage(incoming=True, pattern='/replyraid'))
...
@Rudra1.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@Rudra2.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@Rudra3.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@Rudra4.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@Rudra5.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
...
@Rudra1.on(events.NewMessage(incoming=True))
@Rudra2.on(events.NewMessage(incoming=True))
@Rudra3.on(events.NewMessage(incoming=True))
@Rudra4.on(events.NewMessage(incoming=True))
@Rudra5.on(events.NewMessage(incoming=True))
async def fuck(e):
    global enemy
